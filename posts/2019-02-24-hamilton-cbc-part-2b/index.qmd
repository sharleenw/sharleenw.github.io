...
image: "image.jpg"
image-alt: "A Dark-eyed Junco on a branch (Source: Public Domain Files)"
categories: [birding, visualization]
...
Now they are quite common in the Hamilton area through the winter, with @hsa_birds giving the reasons of climate warming (causing less snow depth), increasing edge habitats where they like to live (due to deforestation), and more bird-feeders. `r emo::ji("chestnut")``r emo::ji("sunflower")`
